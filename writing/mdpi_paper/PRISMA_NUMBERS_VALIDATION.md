...
| 1c | Seeds excluded from API snowball | **2** (of 9) | 9 − 7 = **2** | 12:684–690 (C.2 explanatory sentence: Sajina2021, Sajina2024) | ✅ |
...
| 18 | **Distinct papers** | **121** | `13`: 123 rows = **121 unique titles**; LoRA (ARXIV 2106.09685 + SCOPUS a8ca46…) & Houlsby (ARXIV 1902.00751 + SCOPUS 29ddc1…) each appear twice | 03:37, 03:prisma-caption, 11:12 | ✅ |
