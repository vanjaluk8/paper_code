...
| **Risk of bias in studies** | 18 | Present assessments of risk of bias for each included study. | **§3.3 Quality Assessment** (`sec:methodology:quality`) + **Fig. 6** (`fig:quality_bands`) — reporting-completeness distribution across all 123 records (mean 6.04/10; bands 13/61/47/2 over the 0–10 scale; Q5 reported separately, n=16); full record-by-record scores in accompanying material (Fig. 6) |
