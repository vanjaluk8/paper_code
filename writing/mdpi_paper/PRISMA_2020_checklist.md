...
| **Study risk-of-bias assessment** | 11 | Specify the methods used to assess risk of bias in the included studies, including details of the tool(s) used, how many reviewers assessed each study, and whether they worked independently. | Not applicable — synthesis of published methods/systems literature, no comparative participant-level intervention; quality assessed at full-text stage (§3.2) as topical relevance and venue quality. Stated as an SLR-specific adaptation |
...
| **Availability of data, code, and other materials** | 27 | Report which of the following are publicly available and where they can be found: template data collection forms; data extracted from included studies; data used for all analyses; analytic code; any other materials used in the review. | Data and code available in the accompanying repository: consolidated pipeline `pipeline_unified.csv`, screening/retrieval logs (`log_retrieval_2026-04-21.json`, `log_screening_2026-04-21.json`), extraction spreadsheet `11_data_extraction_2026-05-12.csv`, snowballing engine source; PRISMA flow generation (`app/visualise.py`, `app/prisma.py`). |
