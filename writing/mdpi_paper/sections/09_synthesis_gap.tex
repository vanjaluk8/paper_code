...
Gossip Learning \cite{HegeduisGossip2019}   & (\checkmark)$^\ddagger$& $\times$   & \checkmark  & $\times$    & $\times$    & $\times$    & \checkmark \\
\midrule
...
empirical work. $\ddagger$\ The Gossip Learning \emph{Frozen backbone} mark
is provisional pending verification against the primary source and will be
confirmed or corrected in a later revision.}
\end{tabular}
\end{table}
