...
\begin{enumerate}
  ...
  \item \textbf{Federated PEFT confirms communication efficiency but requires
    ...
    shows that adapter-only exchange reduces per-round communication cost by
    90--99\% compared to full gradient or weight exchange
...
Appendix~\ref{app:db_queries:adversarial}; grey-literature methodology after
