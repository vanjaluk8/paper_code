...
\begin{figure}[H]
  ...
  \caption{Switch Transformer routing (own figure): a learned router assigns
    ...
    co-located expert pool, achieving a 4$\times$ speedup over T5-XXL at
    equivalent quality \cite{Fedus2022}.}
...
At the finest granularity, MOELoRA \cite{LiuMOELoRA2023} attaches separate LoRA experts
