...
Recent work on decentralized LoRA, such as Dec-LoRA by Ghiasvand et al.~\cite{Ghiasvand2025}, demonstrates that parameter-efficient LLM fine‑tuning can be performed without a central server over decentralized communication topologies, motivating similar designs for adapter-based systems.
