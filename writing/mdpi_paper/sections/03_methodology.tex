...
venue. Of these nine seeds, seven were submitted to the automated
citation-snowballing pipeline; the remaining two ({\v{S}}ajina 2025;
{\v{S}}ajina et al.\ 2024) entered the corpus directly via the pre-validated
G0--G6 corpus rather than through automated retrieval. Six thematically focused
...
full-text review. The full-text review queue additionally carried
\textbf{173} borderline-DEFER records for closer inspection, giving a queue of
\textbf{387} (214 KEEP ${}+{}$ 173 DEFER), of which \textbf{190} (all
KEEP-origin) underwent data extraction, and a manual Scopus/WoS top-up brought
...
\begin{table}[H]
\centering
\caption{Pre-validated corpus groups: scope, size, and review section coverage.\footnotemark[1]}
\label{tab:groups}
...
\begin{figure}[H]
  ...
  \caption{PRISMA 2020 flow diagram. Records trace from \textbf{1,150} raw
           ...
           final reading list (\textbf{120} distinct papers).}
  \label{fig:prisma}
\end{figure}
...
($n=16$), all of which recorded a contribution type and \textstar~code(s).
