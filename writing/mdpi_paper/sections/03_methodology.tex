...
corpus. Enrichment and a topical-relevance/tier filter
...
not proceed further. %CORRECTED 2026-08-30 (Blocking Issue #2, verified via
...
${}+{}$ 173 DEFER). Of these, \textbf{191} (190 KEEP-origin and 1 DEFER-origin)
underwent data extraction; the remaining \textbf{196} (24 KEEP-origin,
full text unavailable; 172 DEFER-origin, not taken further) were excluded.
...
%Scopus/WoS cross-validation search contributed 33 further records extracted
%in parallel, entering directly at the extraction stage without ever passing
%through the 387-record full-text queue (verified: all 33 have no S5/S6/S7b/Q9
%stage flags set in pipeline_unified.csv). None of the 33 were ultimately
%retained in the final 123-record list.
A supplementary manual Scopus/WoS cross-validation search contributed
\textbf{33} further records extracted in parallel, entering directly at the
extraction stage without passing through the full-text queue; none of these
33 were ultimately retained in the final 123-record list. The extraction-stage
total is therefore \textbf{224} (191 ${}+{}$ 33). Full-text reading and quality assessment
...
and their motivations are detailed in the appendix.
...
backward snowball additions). The 123 records (120 distinct papers) are
...
\begin{figure}[H]
  ...
  \caption{PRISMA 2020 flow diagram. Records trace from \textbf{1,150} raw
           ...
           (\textbf{387}), of which \textbf{191} reach data extraction; a
           separate \textbf{33}-record manual Scopus/WoS cross-validation
