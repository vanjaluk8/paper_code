...
DEFER, and \textbf{72} SKIP; their retained records advanced alongside the
queue to data extraction via the \texttt{abstract-2nd-pass} route, and
\textbf{53} of the 123 final records trace to this supplementary branch. %CORRECTED 2026-08-30 (Blocking Issue #2, verified via
...
Figure~\ref{fig:prisma}), and the remaining \textbf{53} (43.1\%) were added
by the supplementary forward-citation snowball described below and were
screened in a second abstract-review pass before data extraction. Both cohorts
