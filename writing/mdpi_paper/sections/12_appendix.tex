...
387 queued; see text), and a subset was read in full and extracted before
being excluded at final curation.}
\label{tab:abstract}
\begin{tabular}{lrr}
\toprule
...
\textbf{387} records; of these, \textbf{190} (all KEEP-origin) underwent data
extraction, and a manual Scopus/WoS top-up brought the extraction set to
\textbf{224} (\texttt{11\_data\_extraction\_2026-05-12.csv}). A subset of the
