...
inspection precisely because they were borderline, and were then dropped
without individual assessment or a coded exclusion reason. This is
disclosed here as a genuine Item 16b reporting gap, not a voluntary
limitation (\S\ref{sec:conclusion:threats}); the raw records are archived
in \texttt{verify/wp13\_defer\_records.csv} for the author's own eventual
assessment.
