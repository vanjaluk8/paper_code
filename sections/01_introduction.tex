...
substrate, and small task-specific adapter modules---lightweight,
...
This review was conceived to evaluate a specific, pre-identified research
direction --- a peer-to-peer, adapter-based inference architecture --- against
the existing body of evidence, rather than to derive a research question
from an unguided survey of the literature. This is a common and
methodologically legitimate mode of constructing a research question in
applied computer science: the practice of identifying a research direction
first and using a systematic review to test, scope, and situate it against
prior work is well established, and is distinct from claiming that the
direction itself was discovered through the review process. Accordingly,
the gap claims developed in Section~\ref{sec:synthesis_gap} should be read
as the outcome of a deliberate evaluation of a stated research direction
against a systematically assembled evidence base, not as an emergent
finding from theory-free literature discovery. Section~\ref{sec:methodology}
describes both the confirmatory retrieval process used to assemble the
evidence base and a supplementary adversarial search conducted
specifically to seek evidence against this review's own research
direction (Section~\ref{sec:conclusion:threats}).

This problem sits at the intersection of three active research fields, which this
review decomposes into five sub-questions, each addressed by one section:
\begin{enumerate}
...
Prior surveys that cover these areas do not close this gap either ---
Table~\ref{tab:related_surveys} consolidates every prior review or
survey-like study named in this manuscript, including those identified by
the dedicated related-reviews search of Section~\ref{sec:methodology:search},
by pillar coverage. Comprehensive reviews of
...
unit of capability in a decentralised system. Conversely, {\v S}ajina et al.'s study of
autonomous P2P connection establishment \cite{SajinaP2PConnection2024}, and system papers on
decentralised federated learning such as Ye et al.~\cite{YeDecentralizedFL2022} and Wink and
Nochta~\cite{WinkP2PFL2021}, address the network and protocol
...
P2P substrate; none examines the two jointly. The specific synthesis gap this review identifies is
