...
following a single-wave adaptation of the procedure of Wohlin et
al.~\cite{Wohlin2014}: the procedure as published is iterated until no new
...
following a single-wave adaptation of the procedure of Wohlin et
al.~\cite{Wohlin2014} (one forward/backward wave, not iterated to saturation).
