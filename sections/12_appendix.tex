...
% -----------------------------------------------------------------------
\subsection*{Related-Reviews Search (2026-09-10)}
...
% -----------------------------------------------------------------------
\subsection*{Disconfirming (Adversarial) Search (2026-09-10)}
...
2026-09-10  & Related-reviews search: WoS + Scopus, one query each
  (\S\ref{app:db_queries:related}); screening for competing secondary studies &
...
2026-09-10  & Disconfirming (adversarial) search: 8 queries across arXiv,
  GitHub, and web, no venue filter (\S\ref{app:db_queries:adversarial}) &
