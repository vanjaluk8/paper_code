...
Table~\ref{tab:concept_matrix} scores 17 systems rather than the full 123-record
corpus. The 17 were selected as follows: the two foundational adapter methods
...
approach to the decentralised target. Incremental variants that share a
...
\centering
\footnotesize
\caption{Concept matrix: 17 selected systems against seven design dimensions of the target
