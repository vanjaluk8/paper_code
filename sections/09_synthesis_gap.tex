...
\midrule
\textit{Combined reference profile}                 & \checkmark & \checkmark  & \checkmark  & \checkmark  & \checkmark  & $\times^{\dagger}$    & \checkmark \\
\bottomrule
