...
| **Availability of data, code, and other materials** | 27 | Report which of the following are publicly available and where they can be found: template data collection forms; data extracted from included studies; data used for all analyses; analytic code; any other materials used in the review. | Held in two publicly available repositories (see Data Availability statement): `papers_code` (this manuscript, curated corpus `papers_repo/G0–G6`, PRISMA package) at <https://github.com/vanjaluk8/paper_code> and `slr_engine` (snowballing/retrieval/screening/extraction pipeline source, incl. `app/visualise.py`, `app/prisma.py`) at <https://github.com/vanjaluk8/slr_engine>. Version-controlled per-record artefacts in `slr_engine`: `13_final_reading_list_2026-05-12.csv` (final reading list), `pipeline_unified.csv` (per-stage membership of every record), `log_retrieval_2026-04-21.json` and `log_screening_2026-04-21.json` (retrieval log; per-record title-screening decisions), `S7b_abstract_reviewed_final.csv` (per-record abstract-review disposition), `11_data_extraction_2026-05-12.csv` (224-row extraction spreadsheet), `14_final_curation_reasons.csv` (per-record eligibility-stage exclusion codings), `PRISMA_summary_2026-04-21.md`. Analytic/verification code: `scripts/verify_prisma_counts.py`, `scripts/verify_quality_appraisal.py` (run outputs in `snowball_output/verification_runs/`). Per-study quality-appraisal scores: `quality_appraisal_scored.csv` (Supplementary S2). |
