...
=====================================================================
TOP-UP SEARCH QUERIES — run 2026-09-12 (post peer review, Major #19)
=====================================================================
Same 20 Boolean queries as above, re-run verbatim except for the year
bound, to check for literature published after the original search
(2026-04/05). Scopus: PUBYEAR > 2025; WoS: PY=2026-2026 (both then
additionally date-refined in-platform to 2026-05-13 onward, to exclude
Jan-May 2026 records the original search already covered).
Results: verify/major19_eligibility_decisions.csv (93 candidates -> 65
kept after screening -> 4 retained after eligibility review: DyMerge-LoRA,
AdaFuse, TailorLLM, DeCAF).

SCOPUS TOP-UP QUERIES (year bound: PUBYEAR > 2025)
...
Query 8: NL-to-SQL with Adapters
...
Query 9: Sequence Labelling & Token Classification with PEFT
...
WEB OF SCIENCE TOP-UP QUERIES (year bound: PY=2026-2026)
...
Query 2: Multi-Task Adapter Inference (WoS)
TS=(("adapter*" OR "LoRA" OR "PEFT")
AND ("multi-task" OR "multitask")
AND ("inference" OR "serving" OR "edge" OR "distributed"))
NOT TS=("medical" OR "healthcare" OR "sentiment")
AND PY=2026-2026
